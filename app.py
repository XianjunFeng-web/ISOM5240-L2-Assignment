...
uploaded_image = st.file_uploader("First, pick up an image and then start our story journey", type=["jpg", "jpeg", "png"])
...
st.write("Click to turn your Image into Audio Story")
